...
private:
    ...
    int8_t previousMouseAction_[5]{0, 0, 0, 0, 0}; ///< Data representation of the previous mouse action
    int8_t mouseAction_[5]{0, 0, 0, 0, 0};         ///< Data representation of a mouse action
};
