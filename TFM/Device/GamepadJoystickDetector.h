...
namespace Detector
{
    ...
    private:
        const uint16_t moveUpRightLimit_{924};  ///< Limit to consider a move up/right (read value must be higher)
        const uint16_t moveDownLeftLimit_{100}; ///< Limit to considere a move down/left (read value must be lower)
